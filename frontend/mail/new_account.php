...
<tr>
    <td style="padding:40px 20px; font-family:'Open Sans',arial, sans-serif; font-size:13px"><p><br/>Hello <?= (isset($model->name)) ? $model->name . ' ' . $model->last_name . ',' : "there " ?></p>
        <p style=" font-family:'Open Sans',arial, sans-serif; font-size:13px;">Thank you for booking a property in Lootah Biofuels Please find you access detail for login</p>
