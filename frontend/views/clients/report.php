                                    ...
                                    foreach ($me as $mes) {
                                        ...
                                        foreach ($deps as $dib) {
                                            ...
                                            <tr>
                                                ...
                                                <td><?php
                                                    $stn = \common\models\LbStation::find()->where(['id' => $dib->station_id])->one(); //
                                                    if (!empty($stn->station_name)) {
                                                        echo $stn->station_name;
                                                    } else {
                                                        echo "N/A";
                                                    }
                                                    ?></td>
                                                <td><?php
                                                    $pl = \common\models\LbClientVehicles::find()->where(['id' => $dib->PlateNo])->one(); //
                                                    if (!empty($pl->vehicle_number)) {
                                                        echo $pl->vehicle_number;
                                                    } else {
                                                        echo "N/A";
                                                    }
                                                    ?></td>
