               ...
               <div class="row">
                    ...
                    <div class="col-lg-12 col-12">
                        <div class="card">
                            ...
                            $model= \common\models\LbClients::find()->where(['id' => Yii::$app->session->get('clid')])->one();
                            ?>
                            <div class="col-xl-3 col-md-3 col-sm-6 col-xs-12 mb-4">
                            <?php
                                        if($deps->profile_image){
                                        ?>
                                        <img src="<?= Yii::$app->request->baseUrl . '/uploads/clients/' . $model->id . '/' . $model->profile_image; ?>"
                             ...
                             <div class="col-xl-6 col-md-6 col-sm-6 col-xs-12 mb-4">
                                    <?= $form->field($model, 'profile_image')->fileInput(['maxlength' => true,'class'=>'form-control']) ?>
                                </div>
                                <div class="col-xl-6 col-md-6 col-sm-6 col-xs-12 mb-4">
                           ...
                           <div class="col-xl-6 col-md-6 col-sm-6 col-xs-12 mb-4">
                                    <?= $form->field($model, 'emirate')->textInput(['maxlength' => true,'class'=>'form-control']) ?>
                            </div>
                            <div class="col-xl-6 col-md-6 col-sm-6 col-xs-12 mb-4">
                                    <?= $form->field($model, 'contact_person')->textInput(['maxlength' => true,'class'=>'form-control']) ?>
                            </div> 
                            <div class="col-xl-6 col-md-6 col-sm-6 col-xs-12 mb-4">
                                    <?= $form->field($model, 'contactperson_position')->textInput(['maxlength' => true,'class'=>'form-control']) ?>
                            </div>
                            <hr class="mb-0">
