    ...
    <div class="uk-width-1-3@m uk-width-1-3@s m-auto rounded">
        <div class="uk-child-width-1-1@m uk-grid-collapse " uk-grid>
            ...
            <div class="uk-card-default py-4 px-5">
                ...
                <?php
                $form = ActiveForm::begin(['enableClientScript' => false, 'class' => 'uk-grid-small uk-grid', 'action' => 'login']);
                $userr = new \common\models\LbClients();
                ?> 
                ...
                <div class="mt-4 uk-flex-middle uk-grid-small" uk-grid>
                    <div class="uk-width-expand@s">
                        <!--<div class="checkbox">
                            ...
                            <label for="chekcbox2"><span class="checkbox-icon"></span> Keep me signed in</label>
                        </div>-->
                    </div>
