        ...
        <div id="main_header" class="header-transparent" uk-sticky="top:10; cls-inactive :header-transparent">
            <header>
                ...
                <div class="head_search uk-visible@m">
					<span>Welcome
                                        <?php 
                                        $uid=Yii::$app->session->get('tanopid');
                                        $name= \common\models\LbTankerOperator::find()->where(['id' => $uid])->one();
                                        echo $name->name;
                                        ?></span>
					<small>Tanker Operator
                                        </small>
                    <form>
                ...
                <div class="head_user">
                    ...
                    <?php
                        if($name->image){
                    ?>
                    <img src="<?= Yii::$app->request->baseUrl . '/uploads/tankeroperator/' . $name->id . '/' . $name->image; ?>">
                    <?php
                        }else{
                    ?>
                    ...
                    <div uk-dropdown="pos: top-right;mode:click ; animation: uk-animation-slide-bottom-small"
                        ...
                        <ul class="dropdown-user-menu">
                            <li><a href="<?= Yii::$app->request->baseUrl; ?>/tankeroperator/profile"> <i class="uil-user"></i> My Profile </a> </li>
                            <li class="menu-divider">  </li>
                            <li><a href="<?= Yii::$app->request->baseUrl; ?>/tankeroperator/logout"> <i class="icon-feather-log-out"></i> Sign Out</a> </li>
                        </ul>
