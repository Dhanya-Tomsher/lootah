...
<?php
$deps = \common\models\LbAreaManager::find()->where(['id' => Yii::$app->session->get('armid')])->one();
                    ...
                    <div class="col-12">
                        <div class="card min-box">
                            <div class="card-header">
                                ...
                                <p><a href="<?= Yii::$app->request->baseUrl; ?>/areamanager/changepwd">Change Password</a></p>
                                <p><a href="<?= Yii::$app->request->baseUrl; ?>/areamanager/editprofile">Edit Profile</a></p>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="users-view-image ml-lg-2">
                                        ...
                                        if($deps->image){
                                        ?>
                                        <img src="<?= Yii::$app->request->baseUrl . '/uploads/areamanager/' . $deps->id . '/' . $deps->image; ?>"
