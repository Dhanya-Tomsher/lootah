        ...
        <div id="main_header" class="header-transparent" uk-sticky="top:10; cls-inactive :header-transparent">
            <header>
                ...
                <div class="head_search uk-visible@m">
					<span>Welcome
                                        <?php 
                                        $uid=Yii::$app->session->get('armid');
                                        $sup= \common\models\LbAreaManager::find()->where(['id' => $uid])->one();
                                        $name=$sup->name;
                                        echo $name;
                                        ?></span>
					<small>Area Manager
                ...
                <div class="head_user">
                    ...
                    <a class="opts_account">
                        <?php
                                if($sup->image){
                            ?>
                                <img src="<?= Yii::$app->request->baseUrl . '/uploads/areamanager/' . $sup->id . '/' . $sup->image; ?>"
                    ...
                    <div uk-dropdown="pos: top-right;mode:click ; animation: uk-animation-slide-bottom-small"
                        ...
                        <ul class="dropdown-user-menu">
                            <li><a href="<?= Yii::$app->request->baseUrl; ?>/areamanager/profile"> <i class="uil-user"></i> My Profile </a> </li>
                            <li class="menu-divider">  </li>
                            <li><a href="<?= Yii::$app->request->baseUrl; ?>/areamanager/logout"> <i class="icon-feather-log-out"></i> Sign Out</a> </li>
                        </ul>
                    </div>
