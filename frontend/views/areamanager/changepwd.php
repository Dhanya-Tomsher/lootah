                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                                         <?php if (Yii::$app->session->hasFlash('pwssuccess')): ?>
                            <div class="alert alert-success alert-dismissable">
                            <?= Yii::$app->session->getFlash('pwssuccess') ?>
                            </div>
                        <?php endif; ?>
                        <?php if (Yii::$app->session->hasFlash('pwderror')): ?>
                            <div class="alert alert-danger alert-dismissable">
                            <?= Yii::$app->session->getFlash('pwderror') ?>
                            </div>
                        <?php endif; ?>
                                        <form method="post" action="<?= Yii::$app->request->baseUrl; ?>/areamanager/changepwd" class="uk-child-width-1-2@s uk-grid-small p-4 uk-grid" uk-grid="">
