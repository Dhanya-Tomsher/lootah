...
<?php
$deps = \common\models\LbSupervisor::find()->where(['id' => Yii::$app->session->get('armid')])->one();
            ...
            <div class="page-content-inner">
               ...
               <div class="row">
                    <div class="col-lg-9">
                        ...
                        <?php endif; ?>
                                        <form method="post" action="<?= Yii::$app->request->baseUrl; ?>/supervisor/changepwd" class="uk-child-width-1-2@s uk-grid-small p-4 uk-grid" uk-grid="">
