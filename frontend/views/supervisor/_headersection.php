        ...
        <div id="main_header" class="header-transparent" uk-sticky="top:10; cls-inactive :header-transparent">
            <header>
                ...
                <div class="head_search uk-visible@m">
					<span>Welcome
                                        <?php 
                                        $uid=Yii::$app->session->get('supid');
                                        $sup= \common\models\LbSupervisor::find()->where(['id' => $uid])->one();
                                        $name=$sup->name;
                                        echo $name;
                                        ?>
                                            </span>
                ...
                <div class="head_user">
                    ...
                    <a class="opts_account">
                            <?php
                                if($sup->image){
                            ?>
                                <img src="<?= Yii::$app->request->baseUrl . '/uploads/supervisor/' . $sup->id . '/' . $sup->image; ?>"
                    ...
                    <div uk-dropdown="pos: top-right;mode:click ; animation: uk-animation-slide-bottom-small"
                        ...
                        <ul class="dropdown-user-menu">
                            <li><a href="<?= Yii::$app->request->baseUrl; ?>/supervisor/profile"> <i class="uil-user"></i> My Profile </a> </li>
                            <li class="menu-divider">  </li>
                            <li><a href="<?= Yii::$app->request->baseUrl; ?>/supervisor/logout"> <i class="icon-feather-log-out"></i> Sign Out</a> </li>
                        </ul>
