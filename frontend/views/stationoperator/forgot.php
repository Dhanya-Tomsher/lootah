...
<form name="frm" onsubmit="return validation();" class="uk-grid-small uk-grid" action="<?= Yii::$app->request->baseUrl; ?>/stationoperator/forgotpwdsub" method="POST">
                        ...
                        <div class="mt-4 uk-flex-middle uk-grid-small" uk-grid>
                            <div class="uk-width-expand@s">
                                <p>Back to <a href="<?= Yii::$app->request->baseUrl; ?>/stationoperator/index">Login</a></p>
                            </div>
...
<script>
    ...
    function validation() {
     ...
     $.ajax({
        type: "POST",
        url: "<?= Yii::$app->request->baseUrl. '/stationoperator/findemail'; ?>",
        dataType: "text",
        data: {email:str},
