               ...
               <div class="row">
                    ...
                    <div class="col-lg-12 col-12">
                        <div class="card">
                            ...
                            $model= \common\models\LbStationOperator::find()->where(['id' => Yii::$app->session->get('stopid')])->one();
                            ?>
                            <div class="col-xl-3 col-md-3 col-sm-6 col-xs-12 mb-4">
                            <?php
                                        if($deps->image){
                                        ?>
                                        <img src="<?= Yii::$app->request->baseUrl . '/uploads/stationoperator/' . $model->id . '/' . $model->image; ?>"
