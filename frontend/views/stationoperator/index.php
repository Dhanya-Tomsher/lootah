            ...
            <div class="uk-child-width-1-1@m uk-grid-collapse " uk-grid>
                ...
                <div class="uk-card-default py-4 px-5">
                    <div class="mt-4 mb-2 uk-text-center">
                        <h3 class="mb-0"> Station Operator Login</h3>
                    ...
                    $userr = new \common\models\LbStationOperator();
                    ?>
                    <?php if (Yii::$app->session->hasFlash('success')): ?>
                        ...
                        <div class="uk-form-group">
                            ...
                            <div class="uk-position-relative w-100">
                                ...
                                <?= $form->field($userr, 'username')->textInput(['class'=>'uk-input','maxlength' => true, 'id' => 'email', 'placeholder' => 'Email'])->label(FALSE);
                                ?>
                            </div>
                        </div>
                        <div class="uk-form-group">
