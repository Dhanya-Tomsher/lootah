...
/* @var $searchModel common\models\LbClientMonthlyPriceSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Lb Client Monthly Prices';
                ...
                <div class="x_panel">
                    <div class="x_title">
                        ...
                        <ul class="nav navbar-right panel_toolbox">
                            ...
                            <?= Html::a('Create Lb Client Monthly Price', ['create'], ['class' => 'btn btn-success']) ?>
