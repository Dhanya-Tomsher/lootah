            ...
            <div class="col-12">
                <div class="card ">
                    <div class="card-header">
                        <h4 class="float-left">Stock Consumption Report</h4>
                        <?= Html::a('Export Data', ['exportstockconreport' . $url], ['class' => 'btn btn-success float-right green']) ?>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <?php
                            $form = ActiveForm::begin(['method' => 'get', 'enableClientScript' => false, 'class' => 'uk-grid-small uk-grid', 'action' => 'stockconreport', 'options' => ['enctype' => 'multipart/form-data']]);
                            ?>
                            ...
                            <div class="col-xl-4 col-md-4 mb-2">
                                <?= $form->field($model, 'date_entry')->textInput(['maxlength' => 255, 'type' => 'datetime-local', 'class' => 'form-control your class'])->label('From'); ?>
                            </div>
                            <div class="col-xl-4 col-md-4 mb-2">
                                <?= $form->field($model, 'created_at')->textInput(['maxlength' => 255, 'type' => 'datetime-local', 'class' => 'form-control your class'])->label('To'); ?>
                            </div>
...
<div
                        ...
                        <h4>Stock Consumption Report</h4>
                    </div>
