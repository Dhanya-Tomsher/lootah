            ...
            <div class="col-12">
                <div class="card ">
                    <div class="card-header">
                        <h4 class="float-left">Tank Calibration Report</h4>
                        <?= Html::a('Export Data', ['exportcalibreport' . $url], ['class' => 'btn btn-success float-right green']) ?>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <?php
                            $form = ActiveForm::begin(['method' => 'get', 'enableClientScript' => false, 'class' => 'uk-grid-small uk-grid', 'action' => 'calibreport', 'options' => ['enctype' => 'multipart/form-data']]);
                            ?>
...
//                                'UUID',
                                    ...
                                    'date_caliberation',  
                                                'physical_quantity_gallon',  
                                                'quantity_calculation_gallon',  
                                                'calibrated_quantity_gallon',  
                                ],
                            ]);
                            ?>
</div>
