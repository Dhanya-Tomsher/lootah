            ...
            <div class="col-12">
                <div class="card ">
                    <div class="card-header">
                        ...
                        <?= Html::a('Export Data', ['exportpricelist' . $url], ['class' => 'btn btn-success float-right green']) ?>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <?php
                            $form = ActiveForm::begin(['method' => 'get', 'enableClientScript' => false, 'class' => 'uk-grid-small uk-grid', 'action' => 'pricelist', 'options' => ['enctype' => 'multipart/form-data']]);
                            ?>
                            ...
                            <div class="col-xl-4 col-md-4 mb-2">
                                <?php
                                echo $form->field($model, 'client_id')->dropDownList(ArrayHelper::map(\common\models\LbClients::find()->where(['status' => 1])->all(), 'id', 'name'), ['prompt' => 'Choose Client', 'class' => 'form-control']);
                                ?>                                
                            </div>
                            <div class="col-xl-4 col-md-4 mb-2">
                            ...
                            GridView::widget([
                                ...
                                'columns' => [
                                    ...
                                    [
                                        'attribute' => 'client_id',
                                        'header' => 'Client Name',
                                        'filter' => ArrayHelper::map(\common\models\LbClients::find()->all(), 'id', 'name'),
                                        'filterInputOptions' => ['class' => 'form-control selectpicker', 'id' => null, 'prompt' => 'All', 'data-live-search' => "true", 'title' => "Client", 'data-hide-disabled' => "true"], // to change 'Todos' instead of the blank option
                                        'value' => function($data) {
