...
/* @var $searchModel common\models\LbOperatorTankerAssignmentSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Lb Operator Tanker Assignments';
                ...
                <div class="x_panel">
                    <div class="x_title">
                        ...
                        <ul class="nav navbar-right panel_toolbox">
                            ...
                            <?= Html::a('Create Lb Operator Tanker Assignment', ['create'], ['class' => 'btn btn-success']) ?>
