...
/* @var $searchModel common\models\LbClientMonthlyDetailsSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Lb Client Monthly Details';
                ...
                <div class="x_panel">
                    <div class="x_title">
                        ...
                        <ul class="nav navbar-right panel_toolbox">
                            ...
                            <?= Html::a('Create Lb Client Monthly Details', ['create'], ['class' => 'btn btn-success']) ?>
