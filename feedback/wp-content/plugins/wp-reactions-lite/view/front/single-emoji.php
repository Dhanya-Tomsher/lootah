...
<div class="<?php echo $data['emoji']; ?> wpra-reaction <?php if ( $data['already'] == $data['emoji'] ) { echo 'active ';} ?>"
	...
	<span style="background-color: <?php echo $count_color; ?>"
	      class="wpra-arrow-badge arrow-bottom-left <?php if ( $data['start_count'] == 0 ) {echo 'hide-count';} ?>">
		<span style="border-top-color: <?php echo $count_color; ?>"
		      class="tail"></span>
