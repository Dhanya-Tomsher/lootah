...
/**
 * This is the model class for table "lb_tanker_operator".
 *
 * @property int $id
 ...
 * @property int $status
 */
class LbTankerOperator extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function uploadFile($file, $name, $id){
        ...
        $targetFolder = \yii::$app->basePath . '/../uploads/tankeroperator/' . $id . '/';
