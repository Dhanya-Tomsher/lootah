...
/**
 * LbTankerOperatorSearch represents the model behind the search form of `common\models\LbTankerOperator`.
 */
class LbTankerOperatorSearch extends LbTankerOperator
{
    /**
     * {@inheritdoc}
     */
